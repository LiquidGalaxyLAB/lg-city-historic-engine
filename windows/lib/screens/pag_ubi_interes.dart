...
class _PagUbicInteresState extends State<PagUbicInteres> {
  ...
  final Map<String, List<POI>> _data = {
    ...
    'HISTORY / HERITAGE': [
      ...
      POI(name: 'Sant Anastasi Mill', location: '41.6100°N, 0.6200°E', image: 'assets/images_points_of_interest/Sant Anastasi Mill.png'),
    ...
    'URBAN / CITY LANDMARKS': [
      ...
      POI(name: 'Lleida–Pirineus Train Station', location: '41.6214°N, 0.6319°E', image: 'assets/images_points_of_interest/Lleida–Pirineus Train Station.png'),
      POI(name: 'Camps Elisis Park', location: '41.6133°N, 0.6322°E', image: 'assets/images_points_of_interest/Camps Elisis Park.jpg'),
    ],
  };
                  ...
                  Container(
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/images_points_of_interest/lleida_arriba.jpg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
