...
Future<void> insertarDades(Database db) async {
  final batch = db.batch();

  // ══════════════════════════════════════════════
  // UBICACIONS D'INTERÈS  (21 punts)
  // ══════════════════════════════════════════════

  batch.insert('llocs', {
    'categoria': 'ubicacions',
    'nom': 'Parc científic',
    'latitud': 41.6058553,
    'longitud': 0.6066511,
    'altitud': 197.1975577,
  ...
  batch.insert('llocs', {
    'categoria': 'ubicacions',
    'nom': 'Estació de Lleida Pirineus',
    'latitud': 41.6205690,
    'longitud': 0.6326880,
    'altitud': 150.1240322,
    'heading': 27.9441881,
  ...
  batch.insert('llocs', {
    'categoria': 'ubicacions',
    'nom': 'Castell templer de Gardeny',
    'latitud': 41.6086541,
    'longitud': 0.6145339,
    'altitud': 197.1140743,
    'heading': 116.7448884,
  ...
  batch.insert('llocs', {
    'categoria': 'ubicacions',
    'nom': 'Estatua d\'indibil i mandoni',
    'latitud': 41.6151436,
    'longitud': 0.6274045,
    'altitud': 149.2216539,
    'heading': -48.7595857,
  ...
  // ══════════════════════════════════════════════
  // CATEDRALS I ESGLÉSIES  (11 punts)
  // ══════════════════════════════════════════════
  ...
  batch.insert('llocs', {
    'categoria': 'catedrals',
    'nom': 'Iglesia antigua de san Martí',
    'latitud': 41.6176884,
    'longitud': 0.6218894,
    'altitud': 179.5496898,
    'heading': 60.3371300,
  ...
  batch.insert('llocs', {
    'categoria': 'museus',
    'nom': 'Museu d\'Art Modern i Contemporani de Lleida',
    'latitud': 41.6176785,
    'longitud': 0.6295221,
    'altitud': 169.8676987,
    'heading': -62.3325792,
  ...
  // ══════════════════════════════════════════════
  // FETS HISTÒRICS  (17 punts)
  // ══════════════════════════════════════════════

  batch.insert('llocs', {
    'categoria': 'fets',
    'nom': 'Jura de fidelitat a Jaume I',
    'latitud': 41.6180451,
    'longitud': 0.6258326,
    'altitud': 218.8290324,
    'heading': 12.4121608,
  ...
  batch.insert('llocs', {
    'categoria': 'fets',
    'nom': 'Unió del regne de Aragó i comtat de Barcelona',
    'latitud': 41.6167910,
    'longitud': 0.6254991,
    'altitud': 188.3243688,
    'heading': -25.2592959,
  ...
  batch.insert('llocs', {
    'categoria': 'fets',
    'nom': 'Primera universitat del regne d\'Aragó',
    'latitud': 41.6146803,
    'longitud': 0.6198760,
    'altitud': 178.7109539,
    'heading': -70.5474710,
  ...
  batch.insert('llocs', {
    'categoria': 'fets',
    'nom': 'Revolta d\'Indíbil i Mandoni',
    'latitud': 41.6191230,
    'longitud': 0.6232056,
    'altitud': 188.3243688,
    'heading': -25.2592959,
