  ...
  final Map<String, List<POI>> _data = {
    'SCIENCE / TECHNOLOGY': [
      POI(
        ...
        lat: 41.6094, lng: 0.6212, range: 1000,
      ),
    ],
    'SPORTS': [
      POI(
