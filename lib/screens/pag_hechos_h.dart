  ...
  final Map<String, List<POI>> _data = {
    'Antigüedad': [
      POI(
        ...
        epoca: 'Edat Antiga',
        fechaInici: '206 aC', fechaFi: '205 aC',
        description: 'Indíbil i Mandoni, líders ibers, es van rebel·lar contra Roma en comprendre que Escipió no portaria la independència, sinó una nova ocupació. L\'any 205 aC, van formar una gran coalició de pobles de la vall de l\'Ebre per expulsar els invasors. Tanmateix, es van enfrontar a la superioritat tàctica de les legions en una batalla decisiva. Indíbil va morir en combat lluitant heroicament, cosa que va desmuntar la resistència de les seves tropes.',
      ),
      POI(
        ...
        lat: 41.6191230, lng: 0.6232056, range: 1480.59, heading: -25.26, tilt: 65.45,
        epoca: 'Edat Antiga',
        fechaInici: '49 aC', fechaFi: '49 aC',
        description: 'La Batalla d\'Ilerda va ser un enfrontament magistral de la Segona Guerra Civil romana en què Juli Cèsar va derrotar els generals de Pompeu, Afrani i Petreu, als voltants de l\'actual Lleida. Malgrat quedar aïllat i sense subministraments per una gran crescuda del riu Segre, Cèsar va capgirar la situació amb una brillant maniobra d\'enginyeria i una estratègia de desgast que va envoltar les legions pompeianes.',
      ),
    ],
    'Edad Media Temprana': [
      POI(
      ...
      POI(
        ...
        lat: 41.6191230, lng: 0.6232056, range: 1480.59, heading: -25.26, tilt: 65.45,
        epoca: 'Edat Mitjana',
        fechaInici: '800', fechaFi: '800',
        description: 'L\'any 800, les tropes carolíngies de Lluís el Pietós van assetjar Lleida amb l\'objectiu d\'expandir la Marca Hispànica cap al sud dels Pirineus. L\'exèrcit franc va devastar els voltants de la ciutat per ofegar-la econòmicament. Davant l\'assetjament, el valí de Lleida va pactar una treva de tres anys i el pagament de tributs als francs.',
      ),
      POI(
    ...
    'Edad Moderna': [
      ...
      POI(
        ...
        lat: 41.6191230, lng: 0.6232056, range: 1480.59, heading: -25.26, tilt: 65.45,
        epoca: 'Edat Moderna',
        fechaInici: '1707', fechaFi: '1707',
        description: 'El setembre de 1707, les tropes borbòniques del duc d\'Orleans van assetjar Lleida. Després d\'un mes d\'intensos bombardejos, els borbònics van assaltar la ciutat el 12 d\'octubre. La victòria borbònica va suposar un càstig sever: la ciutat va ser saquejada, va perdre els seus furs i la seva universitat fou clausurada.',
      ),
    ],
    'Edad Contemporánea': [
      POI(
