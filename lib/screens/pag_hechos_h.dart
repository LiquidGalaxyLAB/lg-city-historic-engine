            ...
            children: [
              Container(
                ...
                decoration: const BoxDecoration(
                  image: DecorationImage(image: AssetImage('assets/images/denoche.jpg'), fit: BoxFit.cover),
                ),
              ),
              ...
              const Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Historical events', style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w500)),
                    SizedBox(height: 5),
                    Text('Significant moments in Lleida history', style: TextStyle(color: Colors.white70, fontSize: 14)),
                  ],
                ),
              ),
            ],
