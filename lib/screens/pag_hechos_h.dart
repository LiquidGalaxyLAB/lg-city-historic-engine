        ...
        children: [
          SizedBox(
            ...
            child: Stack(
              fit: StackFit.expand,
              children: [
                Image.asset('assets/images/denoche.jpg', fit: BoxFit.cover),
                ...
                const Positioned(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('Historical events', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w500)),
                      SizedBox(height: 5),
