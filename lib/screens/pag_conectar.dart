...
class _PagConectarState extends State<PagConectar> {
                  ...
                  child: Row(children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: const Text('Disconnect', style: TextStyle(color: Colors.green, fontSize: 13, fontWeight: FontWeight.w600)),
                      ),
                    ),
                  ]),
                ),
  ...
  Widget _campo(String label, TextEditingController controller,
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(label, style: TextStyle(fontSize: 12.5, color: isDark ? Colors.white70 : Colors.black54, fontWeight: FontWeight.w500)),
        const SizedBox(height: 6),
        Container(
          decoration: BoxDecoration(
